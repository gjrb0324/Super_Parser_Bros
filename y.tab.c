...
#define REMARK 259
#define SPACE 260
#define EIGHTSPACE 261
#define NOTARGETS 262
#define FLAG 263
...
{
       0,    33,    33,    34,    35,    36,    37,    40,    41,    47,
      48,    49,    51,    56,    57,    60,    61,    62,    63,    64,
      67,    68,    70,    71,    72,    73,    76,    77,    80,    81,
      84,    85
};
#endif
...
{
  "$end", "error", "$undefined", "FNAME", "REMARK", "SPACE", "EIGHTSPACE",
  "NOTARGETS", "FLAG", "'='", "'-'", "'#'", "':'", "'|'", "$accept",
  "statement", "macroline", "spacerrors", "commanderrors", "remarkline",
  "targetline", "prerequisites", "files", "remarks", YY_NULLPTR
};
#endif
...
{
      21,    12,     7,     1,    19,    -2,    11,    30,    -2,    -2,
      -2,    -2,     7,     9,    22,    -2,    11,     4,    -2,    -2,
      11,    -2,    23,    -2,    -2,    -2,    -2,    -2,    -2,    11,
      11,    11,    -2,    -2,    -2,    -2,    -2,    -2
};
...
{
       0,    29,    31,     9,    11,    19,    23,     0,     6,     4,
       5,     3,     2,    13,    27,    15,    29,     0,    28,    30,
      24,    10,    27,    17,    12,    18,    22,     1,    16,     0,
      21,     0,     7,     8,    25,    14,    20,    26
};
...
{
      14,    18,    21,    24,    16,     2,    26,    16,    19,    23,
      25,     2,    32,    20,    16,    16,    18,    33,    28,    29,
      34,    17,    16,     2,     1,     2,     3,     4,    35,    36,
      27,    37,     5,     6,    30,    31,    31
};
...
{
       0,     1,     3,     4,     3,     4,     6,     3,     2,     3,
       4,     4,     8,    12,     3,     3,    16,    17,    12,    10,
      20,     9,     3,     4,     3,     4,     5,     6,    29,    30,
       0,    31,    11,    12,    12,    13,    13
};
...
{
       0,     3,     4,     5,     6,    11,    12,    15,    16,    17,
      18,    19,    20,    21,    22,    23,     3,     9,    22,    23,
      12,    21,    22,    23,    21,    23,    22,     0,    23,    10,
      12,    13,     8,    22,    22,    21,    21,    22
};
...
yyreduce:
  ...
  case 7:
#line 40 "makefile.y"
                           {setenv((yyvsp[-2].str),(yyvsp[0].str),1);}
#line 1357 "y.tab.c"
    break;
...
#line 1363 "y.tab.c"
  ...
  case 9:
#line 47 "makefile.y"
                  {printf(ANSI_COLOR_MAGENTA "Parser warning: " ANSI_COLOR_RESET); printf("no rule or neglected space to make target.\n"); errno="A", yyerror(errno);}
#line 1369 "y.tab.c"
    break;
...
#line 1381 "y.tab.c"
  ...
  case 12:
#line 51 "makefile.y"
                                     {printf(ANSI_COLOR_RED "Parser error: " ANSI_COLOR_RESET); printf("missing separator (did you mean TAB instead of 8 spaces?).\n"); errno="C"; yyerror(errno);}
#line 1387 "y.tab.c"
    break;

  case 13:
#line 56 "makefile.y"
                             {printf(ANSI_COLOR_RED "Parser error: " ANSI_COLOR_RESET); printf("invalid rule to make target "); printf("\"%s\"\n",(yyvsp[0].str)); errno="D"; yyerror(errno);}
#line 1393 "y.tab.c"
    break;

  case 14:
#line 57 "makefile.y"
                                               {printf(ANSI_COLOR_RED "Parser error: " ANSI_COLOR_RESET); printf("invalid rule to make target\n"); errno="D"; yyerror(errno);}
#line 1399 "y.tab.c"
    break;
...
#line 1405 "y.tab.c"
  ...
  case 16:
#line 61 "makefile.y"
                                {printf("Target line contains remarks.\n\n");}
#line 1411 "y.tab.c"
    break;
...
#line 1429 "y.tab.c"
  ...
  case 20:
#line 67 "makefile.y"
                                    {printf("Target line exists with prerequisite(s).\n\n");}
#line 1435 "y.tab.c"
    break;

  case 21:
#line 68 "makefile.y"
                      {printf("Target line is valid.\n\n");}
#line 1441 "y.tab.c"
    break;
